  ...
  return (
    <main>
      ...
      <section>
        ...
        <Accordion className="accordion">
          ...
          <Accordion.Item id="local-guide" className="accordion-item">
            <Accordion.Title className="accordion-item-title">We are woking with local guides </Accordion.Title>
            <Accordion.Content className="accordion-item-content">
              <article>
                <p>We are not doing alone with our office.</p>
                <p>
                  We are in the business of planning highly individualized
                  vacation trips for more than 20 years.
                </p>
      ...
      <section>
        ...
        <SearchableList items={['items1', 'item2']} itemKeyFn={(item) => item}>
          {(item) => item}
        </SearchableList>
      </section>
    </main>
